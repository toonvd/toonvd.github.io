...
;hljs.registerLanguage("bash",e)})();/*! `rust` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("typescript",e)})();/*! `c` grammar compiled for Highlight.js 11.7.0 */
